  ...
  return (
    <>
        ...
        >
          <div className="container">
            ...
            >
              <ul className="navbar-nav justify-content-center col-12">
                <li className="nav-item ms-md-4 ms-lg-5">
                  <a className="nav-link" href="#Sochal">
                    Contact us
                  </a>
                </li>
                <li className="nav-item ms-md-4 ms-lg-5">
      ...
      <main>
        <section
          id="register-section"
          className="row justify-content-center align-items-center register-section"
        >
          ...
          >
            <div className="form form-font col-8 p-5 ">
              <h3 className="Hero-text-section">Please Enter Your Data</h3>
              <form onSubmit={handelAccounts}>
                <input
                ...
                <button className="Hero-button btn btn-dark mt-3" type="reset">
                  Reset
                </button>
              </form>
            </div>
        ...
        <section className="information-section">
          ...
          <div className="students mt-5">
            ...
            >
              {Accounts.map(user => (
                <div className="student card ms-4 mb-4 form-font col-8 col-sm-4 col-md-3"
                  data-aos="flip-left">
                  ...
                  <button onClick={() => { handelDeleteAccount(user.id) }}>&#10005;</button>
                </div>
              ))}
            </div>
          </div>
      ...
      <footer
        className="row navbar-light bg-light justify-content-center align-items-center me-0"
      >
        <ul className="social nav col-6 list-unstyled d-flex justify-content-center">
          <li className="m-2">
        ...
        <hr className="line-full mb-3" />
        <h3 className="general-font text-center">© 2023. Made by OMAR HASSOUNA</h3>
      </footer>
    </>
  );
}
